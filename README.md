...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe4b76b80d924001531948d
...
To start editing your site, you can use the Sanity interface at https://knowledgeable-lavender-4b76b.sanity.studio/.
...
Generated at `2020-12-24T15:48:34.064Z` by Stackbit version `0.3.41`.